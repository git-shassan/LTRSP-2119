...
It may take a few minutes, but when successfull, it will output the id of the newly created AMI:
    ...
    ==> amazon-ebs.base: Creating AMI xrd-1.28-1706406811 from instance i-054e2affa60cc89eb
    ...
    ==> amazon-ebs.base: Creating AMI tags
        ...
        amazon-ebs.base: Adding tag: "Base_AMI_Name": "amazon-eks-node-1.28-v20240117"
        amazon-ebs.base: Adding tag: "Generated_By": "xrd-packer"
        amazon-ebs.base: Adding tag: "Kubernetes_Version": "1.28"
